...
<div class="container-fluid">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="<?= base_url('super-admin/paket/create') ?>" method="post">
                <?= csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?= isset(session()->getFlashdata('errors')['nama']) ? 'is-invalid' : '' ?>" id="nama" name="nama" value="<?= old('nama') ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control <?= isset(session('errors')['harga']) ? 'is-invalid' : '' ?>" id="harga" name="harga" value="<?= old('harga') ?>" required>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control <?= isset(session('errors')['durasi'])  ? 'is-invalid' : '' ?>" id="durasi" name="durasi" value="<?= old('durasi') ?>" maxlength="3" required>
                                <div class="input-group-text">
                                    Bulan
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?= isset(session('errors')['deskripsi']) ? 'is-invalid' : '' ?>" id="deskripsi" name="deskripsi" rows="3" required><?= old('deskripsi') ?></textarea>
