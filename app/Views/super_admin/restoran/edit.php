...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-edit me-2"></i>Edit Restoran
        </h1>
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-store me-2"></i>Form Edit Restoran
            </h6>
        </div>
        <div class="card-body">
            <form action="<?= base_url('super-admin/restoran/edit/' . $restoran['id']) ?>" method="post">
                    <?= csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?= session('errors.nama') ? 'is-invalid' : '' ?>" 
                                   id="nama" name="nama" value="<?= old('nama', $restoran['nama']) ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?= session('errors.kontak') ? 'is-invalid' : '' ?>" 
                                   id="kontak" name="kontak" value="<?= old('kontak', $restoran['kontak']) ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= session('errors.alamat') ? 'is-invalid' : '' ?>" 
                              id="alamat" name="alamat" rows="3" required><?= old('alamat', $restoran['alamat']) ?></textarea>
