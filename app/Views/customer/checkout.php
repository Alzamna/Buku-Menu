                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <p class="text-muted mb-0">
                                                        Jumlah: <?= $item['jumlah'] ?> x Rp <?= number_format($item['harga'], 0, ',', '.') ?>
                                                    </p>
                                                    <?php if ($item['catatan']): ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="metode" id="dine_in" value="dine_in" checked>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="metode" id="take_away" value="take_away">
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mb-3">
                                        <strong>Total:</strong>
                                        <strong class="text-success">Rp <?= number_format($total * 1.11, 0, ',', '.') ?></strong>
                                    </div>
                                    
                                    <input type="hidden" name="restoran_id" value="<?= session()->get('restoran_id') ?? 1 ?>">
