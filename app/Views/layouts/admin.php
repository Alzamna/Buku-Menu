                ...
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        <?php if (session()->get('role') === 'super_admin'): ?>
                            <li class="nav-item">
                                <a class="nav-link <?= current_url() == base_url('super-admin/dashboard') ? 'active' : '' ?>"
                                    href="<?= base_url('super-admin/dashboard') ?>">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= strpos(current_url(), 'super-admin/admin') !== false ? 'active' : '' ?>"
                                    href="<?= base_url('super-admin/admin') ?>">
                        ...
                        <?php else: ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= strpos(current_url(), 'admin/kategori') !== false ? 'active' : '' ?>"
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= strpos(current_url(), 'admin/meja') !== false ? 'active' : '' ?>"
                                    href="<?= base_url('admin/meja') ?>">
                                    <i class="fas fa-table me-2"></i>Kelola Meja
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?= strpos(current_url(), 'admin/pesanan') !== false ? 'active' : '' ?>"
